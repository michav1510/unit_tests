...
void test_CH2d_dlclist::test_param_constr_case2()
{
	...
	CPPUNIT_ASSERT(*(it2+1)== Point2d(2,1) && *(it2-1) == Point2d(2,1) && *(it2+2) == Point2d(2,0)
		&& *(it2-2) == Point2d(2,0));
...
void test_CH2d_dlclist::test_param_constr_case3()
{
	...
	CPPUNIT_ASSERT(*(iter3) == Point2d(0,0) && *(iter3+1) == Point2d(1,1) && *(iter3+2)== Point2d(1,0) 
...
void test_CH2d_dlclist::test_push_case4()
{
	...
	CPPUNIT_ASSERT( *it4 == Point2d(5,1) && *(it4+1) == Point2d(5,10) && *(it4+2) == Point2d(5,1)
...
void test_CH2d_dlclist::test_push_case5()
{
	...
	CPPUNIT_ASSERT( *it5 == Point2d(3,2) && *(it5+1) == Point2d(5,1) && *(it5+2) == Point2d(3,2)
...
void test_CH2d_dlclist::test_push_case6()
{
	...
	CPPUNIT_ASSERT( *it6 == Point2d(3,2) && *(it6+1) == Point2d(5,1) && *(it6+2) == Point2d(3,2)
...
void test_CH2d_dlclist::test_push_case7()
{
	...
	CPPUNIT_ASSERT( *it7 == Point2d(0,0) && *(it7+1) == Point2d(1,1) && *(it7+2) == Point2d(0,0)
...
void test_CH2d_dlclist::test_push_case8()
{
	...
	CPPUNIT_ASSERT( *it8 == Point2d(-1,-1) && *(it8+1) == Point2d(1,1) && *(it8+2) == Point2d(-1,-1)
...
void test_CH2d_dlclist::test_push_case9()
{
	...
	CPPUNIT_ASSERT( *it9 == Point2d(0,0) && *(it9+1) == Point2d(2,2) && *(it9+2) == Point2d(0,0)
...
void test_CH2d_dlclist::test_push_case10()
{
	...
	CPPUNIT_ASSERT( *it10 == Point2d(1,-1) && *(it10+1) == Point2d(1,1) && *(it10+2) == Point2d(1,-1)
...
void test_CH2d_dlclist::test_push_case11()
{
	...
	CPPUNIT_ASSERT( *it11 == Point2d(1,0) && *(it11+1) == Point2d(1,2) && *(it11+2) == Point2d(1,0)
...
void test_CH2d_dlclist::test_push_case12()
{
	...
	CPPUNIT_ASSERT( *it12 == c12 && *(it12+1) == b12 && *(it12+2) == a12
...
void test_CH2d_dlclist::test_push_case13()
{
	...
	CPPUNIT_ASSERT( *it13 == c13 && *(it13+1) == b13 && *(it13+2) == a13
...
void test_CH2d_dlclist::test_push_case14()
{
	...
	CPPUNIT_ASSERT( *it14 == Point2d(-1,0) && *(it14+1) == Point2d(0,1) && *(it14+2) == Point2d(1,0)
...
void test_CH2d_dlclist::test_push_case15()
{
	...
	CPPUNIT_ASSERT( *it15 == Point2d(-1,0) && *(it15+1) == Point2d(0,1) && *(it15+2) == Point2d(1,0)
...
void test_CH2d_dlclist::test_push_case16()
{
	...
	CPPUNIT_ASSERT( *it16 == Point2d(-1,0) && *(it16+1) == Point2d(1,0) && *(it16+2) == Point2d(0,-1)
...
void test_CH2d_dlclist::test_push_case17()
{
	...
	CPPUNIT_ASSERT( *it17 == Point2d(-1,0) && *(it17+1) == Point2d(0,1) && *(it17+2) == Point2d(1,0)
...
void test_CH2d_dlclist::test_push_case18()
{
	...
	CPPUNIT_ASSERT( *it18 == Point2d(-1,0) && *(it18+1) == Point2d(1,0) && *(it18+2) == Point2d(0,-1)
...
void test_CH2d_dlclist::test_push_case19()
{
	...
	CPPUNIT_ASSERT( *it == Point2d(-4,0.5) && *(it+1) == Point2d(1,2) && *(it+2) == Point2d(2,2) 
...
void test_CH2d_dlclist::test_push_case20()
{
	...
	CH2d_dlclist::ch_iterator it = ch.begin();
	CPPUNIT_ASSERT( *it == Point2d(0,0) && *(it+1) == Point2d(0,2) && *(it+2) == Point2d(2,2) 
					&& *(it+3) == Point2d(3,1) && *(it+4) == Point2d(3,0) && *(it+5) == Point2d(2,-1)
...
void test_CH2d_dlclist::test_push_case21()
{
	...
	CH2d_dlclist::ch_iterator it = ch.begin();
	CPPUNIT_ASSERT( *it == Point2d(0,0) && *(it+1) == Point2d(0,1) && *(it+2) == Point2d(1,2) 
...
void test_CH2d_dlclist::test_push_case22()
{
	...
	CH2d_dlclist::ch_iterator it = ch.begin();
	CPPUNIT_ASSERT( *it == Point2d(0,-1) && *(it+1) == Point2d(0,1) && *(it+2) == Point2d(1,2) 
				&& *(it+3) == Point2d(2,2) && *(it+4) == Point2d(3,1) && *(it+5) == Point2d(3,0) 
...
void test_CH2d_dlclist::test_push_case24()
{
	...
	CPPUNIT_ASSERT(*ch.end() == Point2d(3,0));
	CH2d_dlclist::ch_iterator it = ch.begin();
	CPPUNIT_ASSERT( *it == Point2d(0,0) && *(it+1) == Point2d(0,1) && *(it+2) == Point2d(1.5,2.5) 
				&& *(it+3) == Point2d(3,1) && *(it+4) == Point2d(3,0) && *(it+5) == Point2d(2,-1) 
...
void test_CH2d_dlclist::test_push_case31()
{
	...
	CH2d_dlclist::ch_iterator it = ch.begin();
	CPPUNIT_ASSERT(*it == Point2d(-0.5,0.5) && *(it+1) == Point2d(1,2) && *(it+2) == Point2d(2,2) 
					&& *(it+3) == Point2d(3,1) && *(it+4) == Point2d(3,0) && *(it+5) == Point2d(2,-1) 
